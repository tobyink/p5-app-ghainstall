# App-GhaInstall Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/App-GhaInstall)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/App-GhaInstall)
